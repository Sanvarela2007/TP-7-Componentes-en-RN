...
import { StyleSheet, Text, View, SafeAreaView, TextInput, ImageBackground, TouchableOpacity} from 'react-native';
...
export default function App() {
  ...
  <SafeAreaView style={styles.container} >
    <View style={styles.tarjeta}>
      ...
      <TouchableOpacity><Text>Contactar</Text></TouchableOpacity>
      <TouchableOpacity><Text>Ver Portfolio</Text></TouchableOpacity>
